...
def show_login_page():
    ...
    st.title("Welcome to FreshAlert \U0001F600😀, Let's start together with saving food") 
    st.title("Login")
...
def add_food_to_fridge():
    ...
    new_entry = {
        ...
        DATA_COLUMNS_FOOD[2]: st.selectbox("Kategorie", ["Bitte wählen", '\U0001F966 Gemüse' "Gemüse", "Obst", "Milchprodukte", "Fleisch", "Fisch", "Eier", "Getränke", "Saucen", "Getreideprodukte", "Tiefkühlprodukte", "Gebäcke", "Sonstiges"]), #Kategorie
